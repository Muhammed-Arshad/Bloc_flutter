...
class _$TvShowImpl implements _TvShow {
  ...
  @override
  String toString() {
    return 'TvShow(name: $name, permalink: $permalink, endDate: $endDate, network: $network, status: $status, imageThumbnailPath: $imageThumbnailPath)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, name, permalink, endDate,
      network, status, imageThumbnailPath);
